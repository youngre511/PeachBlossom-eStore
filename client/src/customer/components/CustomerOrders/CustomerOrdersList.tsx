...
import OrdersListHead from "./CustomerOrdersHead";
import { CustomerOrder } from "../../features/UserData/UserDataTypes";
import { useNavigate } from "react-router-dom";
import OrderListRow from "./CustomerOrdersRow";
...
const CustomerOrdersList: React.FC<AVCatProps> = ({
    page,
    results,
    numberOfResults,
    updateSearchParams,
    ...
    const [orderBy, setOrderBy] =
        React.useState<keyof CustomerOrder>("orderDate");
